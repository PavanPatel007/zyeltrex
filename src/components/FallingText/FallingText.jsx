...
const FallingText = ({
      ...
      .map((word) => {
        ...
        return `<span
          class="inline-block mx-[2px] select-none ${
            isHighlighted
              ? "text-black font-semibold bg-gray-400 rounded-full  px-3 my-1"
              : "text-black font-semibold bg-cyan-300 rounded-full  px-3 my-1"
          }"
        >
          ${word}
        </span>`;
  ...
  return (
    <div
      ref={containerRef}
      className="relative z-[1] w-full h-full cursor-pointer text-center pt-8 min-h-[400px] "
